...
public class SLinkedQueue implements Queue { // SLinkedQueue class 작성
	...
	public void add(Object x) { // add() 메소드 작성
	...
	@Override
	public Object remove() { // remove() 메소드 작성
		Object oldHead = 0; // oldHead라는 변수를 생성한다.
	...
	@Override
	public Object first() { // first() 메소드 작성
